...
return [
    ...
    // ใน array 'fonts' ให้เพิ่ม key 'thsarabunnew'
    'fonts' => [
    'thsarabunnew' => [
        'R'  => base_path('resources/fonts/THSarabunNew.ttf'),
        'B'  => base_path('resources/fonts/THSarabunNew-Bold.ttf'),
        'I'  => base_path('resources/fonts/THSarabunNew-Italic.ttf'),
        'BI' => base_path('resources/fonts/THSarabunNew-BoldItalic.ttf'),
    ],
    // … ฟอนต์อื่น ๆ
],
